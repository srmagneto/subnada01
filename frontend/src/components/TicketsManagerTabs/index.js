      ...
      <Paper elevation={0} square className={classes.tabsHeader}>
        ...
        <Stack direction="row" spacing={2} sx={{ display: 'flex', alignItems: 'center', px: 2, py: 3, justifyContent: 'space-between' }}>
          ...
          <Stack direction={'row'} sx={{ alignItems: 'center' }} spacing={1} >
            ...
            <IconButton onClick={(e) => handleChangeTab(e, 'open')} sx={tab == 'open' ? { background: '#ffab11', color: '#fff' } : { color: "#fff", background: '#ccc' }} aria-label="upload picture" component="span">
              <LibraryBooksIcon />
            </IconButton>

            <IconButton onClick={(e) => handleChangeTab(e, 'closed')} sx={tab == 'closed' ? { background: '#ffab11', color: '#fff' } : { color: "#fff", background: '#ccc' }} aria-label="upload picture" component="span">
              <LibraryAddCheckIcon />
            </IconButton>

            <IconButton onClick={(e) => handleChangeTab(e, 'search')} sx={tab == 'search' ? { background: '#ffab11', color: '#fff' } : { color: "#fff", background: '#ccc' }} aria-label="upload picture" component="span">
              <SearchIcon />
            </IconButton>
